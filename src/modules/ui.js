...
const messageStyles = {
  success: { color: '#28a745', backgroundColor: '#d4edda', borderColor: '#c3e6cb' },
  error: { color: '#dc3545', backgroundColor: '#f8d7da', borderColor: '#f5c6cb' }
}

let messageTimer = null

export const uiService = {
  showSuccess: (message) => uiService.showMessage(message, 'success'),
  showError: (message) => uiService.showMessage(message, 'error'),
  ...
  showMessage: (message, type = 'error') => {
    ...
    messageTimer = setTimeout(() => uiService.hideMessage(), duration)
  },
